...
@keyframes loginPulseGlow {
  0%, 100% { box-shadow: 0 0 0 4px rgba(247,253,255,1); }
  50%      { box-shadow: 0 0 0 6px rgba(6,71,113,0.08); }
}
`;
            ...
            <div className="w-full max-w-[445px] mx-auto flex flex-col justify-between h-full">
              ...
              <form onSubmit={handleLogin} className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-1.5">
                    <span style={{ color: '#EC1D42', fontSize: 16, fontWeight: 600, fontFamily: 'SF Pro Display, Inter, sans-serif' }}>*</span>
                    <span style={{ color: '#30313D', fontSize: 14, fontWeight: 500, fontFamily: 'Inter, sans-serif' }}>Password</span>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      {showPassword
                        ? <EyeOff size={19} color="#727272" strokeWidth={1.4} />
                        : <Eye size={19} color="#727272" strokeWidth={1.4} />
                      }
                    </button>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 flex items-center gap-2">
                    <button
                      ...
                      className="relative border-none p-0 cursor-pointer bg-transparent"
                      style={{ width: 33, height: 20 }}
                      title="Remember me toggle"
                    >
                      <div
                        ...
                        style={{
                          width: 33,
                          height: 20,
                          backgroundColor: rememberMe ? '#064771' : '#E5E7EB',
                      ...
                      <div
                        ...
                        style={{
                          ...
                          height: 17,
                          top: 1.5,
                          left: rememberMe ? 14.5 : 1.5,
                          transition: 'left 0.25s ease',
                          boxShadow: '0 1px 3px rgba(0,0,0,0.15)',
                        }}
                      />
                    </button>
                    <span style={{ color: '#1A1A1A', fontSize: 14, fontWeight: 500, fontFamily: 'Inter, sans-serif' }}>
