                ...
                >
                    <div className="w-full max-w-[445px] mx-auto flex flex-col justify-between h-full">
                        ...
                        {!success ? (
                            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex items-center gap-1.5">
                                        <span style={{ color: '#EC1D42', fontSize: 16, fontWeight: 600 }}>*</span>
                                        <span style={{ color: '#30313D', fontSize: 14, fontWeight: 500, fontFamily: 'Inter, sans-serif' }}>Email</span>
                                    </div>
                                    <div
                                        className="h-10 px-3 flex items-center gap-3 bg-white rounded-[3px]"
                                        style={{ outline: '0.5px solid #CBD5E1', outlineOffset: '-0.5px' }}
                                    >
                                        <input
                                            type="email"
                                            value={email}
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex items-center gap-1.5">
                                        <span style={{ color: '#EC1D42', fontSize: 16, fontWeight: 600 }}>*</span>
                                        <span style={{ color: '#30313D', fontSize: 14, fontWeight: 500, fontFamily: 'Inter, sans-serif' }}>New Password</span>
                                    </div>
                                    <div
                                        className="h-10 px-3 flex items-center gap-3 bg-white rounded-[3px]"
                                        style={{ outline: '0.5px solid #CBD5E1', outlineOffset: '-0.5px', transition: 'outline-color 0.25s ease' }}
                                    >
                                        <Lock size={18} color="#727272" strokeWidth={1.4} />
                                        <input
                                            ...
                                            style={{ fontFamily: 'Inter, sans-serif', color: '#30313D' }}
                                        />
                                        <button type="button" onClick={() => setShowPassword(!showPassword)} className="border-none bg-transparent cursor-pointer p-0" title="Toggle password">
                                            {showPassword ? <EyeOff size={19} color="#727272" strokeWidth={1.4} /> : <Eye size={19} color="#727272" strokeWidth={1.4} />}
                                        </button>
                                    </div>
                                    {/* Strength bar */}
                                    {password && (
                                        <div className="flex items-center gap-3" style={{ animation: 'loginFadeSlideUp 0.3s ease-out' }}>
                                            <style>{`@keyframes loginFadeSlideUp { from { opacity: 0; transform: translateY(6px); } to { opacity: 1; transform: translateY(0); } }`}</style>
                                            ...
                                            <span style={{ fontSize: 12, fontWeight: 500, color: strength.color, fontFamily: 'Inter, sans-serif', minWidth: 44 }}>
                                                {strength.label}
                                            </span>
                                        </div>
                                    )}
                                ...
                                <div className="flex flex-col gap-4">
                                    <div className="flex items-center gap-1.5">
                                        <span style={{ color: '#EC1D42', fontSize: 16, fontWeight: 600 }}>*</span>
                                        <span style={{ color: '#30313D', fontSize: 14, fontWeight: 500, fontFamily: 'Inter, sans-serif' }}>Confirm Password</span>
                                    </div>
                                    <div
                                        className="h-10 px-3 flex items-center gap-3 bg-white rounded-[3px]"
                                        style={{ outline: '0.5px solid #CBD5E1', outlineOffset: '-0.5px', transition: 'outline-color 0.25s ease' }}
                                    >
                                        ...
                                        <input
                                            ...
                                            style={{ fontFamily: 'Inter, sans-serif', color: '#30313D' }}
                                        />
                                        <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="border-none bg-transparent cursor-pointer p-0" title="Toggle password">
                                            {showConfirm ? <EyeOff size={19} color="#727272" strokeWidth={1.4} /> : <Eye size={19} color="#727272" strokeWidth={1.4} />}
                                        </button>
                                    </div>
                                    {/* Match indicator */}
                            ...
                            /* Success state */
                            <div className="flex flex-col items-center gap-6 text-center" style={{ animation: 'loginFadeSlideUp 0.5s ease-out' }}>
                                <style>{`
                  @keyframes loginFadeSlideUp { from { opacity: 0; transform: translateY(24px); } to { opacity: 1; transform: translateY(0); } }
                  @keyframes loginCheckPop { 0% { transform: scale(0); opacity: 0; } 60% { transform: scale(1.15); } 100% { transform: scale(1); opacity: 1; } }
                `}</style>
                                <div style={{ animation: 'loginCheckPop 0.6s ease-out 0.15s both' }}>
                                    <CheckCircle size={64} color="#10B981" strokeWidth={1.2} />
                                </div>
                                <h2 style={{ fontSize: 22, fontWeight: 600, color: '#30313D', fontFamily: 'Inter, sans-serif', margin: 0 }}>
                                    Password Reset!
                                </h2>
                                ...
                                <div className="w-8 h-1 rounded-full overflow-hidden bg-gray-200">
                                    <div
                                        className="h-full rounded-full"
                                        style={{
                                            backgroundColor: '#064771',
                                            animation: 'loginProgressBar 3s linear forwards',
                                        }}
                                    />
                                    <style>{`@keyframes loginProgressBar { from { width: 0; } to { width: 100%; } }`}</style>
                                </div>
                            </div>
                        )}
